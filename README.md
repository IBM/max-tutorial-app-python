[![Build Status](https://travis-ci.org/IBM/max-workshop-app-python.svg?branch=master)](https://travis-ci.org/IBM/max-workshop-app-python)
...
> This is the python version of this Web App, you can also check out the [NodeJS version](https://github.com/IBM/max-workshop-app-nodejs)
